...
[![CI Pytest](https://github.com/xivapi/xivapi-py/actions/workflows/ci-pytest.yml/badge.svg)](https://github.com/xivapi/xivapi-py/actions/workflows/ci-pytest.yml)
